  ...
  <body>
    ...
    <div class="container mt-2 pt-2">
        <div class="card" style="width: 18rem;">
            <div class="card-body">
              <h2>Free Talking - Q&A</h2>
              <br />
                <a href ="/book#/FreeTalking-QnA/FreeTalking-STEP1/chapter1">FreeTalking - White 1</a><br />
                <a href ="/book#/FreeTalking-QnA/FreeTalking-STEP2/chapter1">FreeTalking - Yellow 2</a><br />
                <a href ="/book#/FreeTalking-QnA/FreeTalking-STEP3/chapter1">FreeTalking - Green 3</a><br />
                <a href ="/book#/FreeTalking-QnA/FreeTalking-STEP4/chapter1">FreeTalking - Red 4</a>
            </div>
        </div>
    </div>
    ...
    <div class="container mt-2 pt-2">
        <div class="card" style="width: 18rem;">
            <div class="card-body">
              <h2>Free Talking - Opinion</h2>
              <br />
                <a href ="/book#/FreeTalkingOpinion/FreeTalkingOpinion1/chapter1">Unit 1</a><br />
            </div>
        </div>
    </div>
    ...
    <div class="container mt-2 pt-2">
        <div class="card" style="width: 18rem;">
            <div class="card-body">
              ...
              <br />
                <a href ="/book#/FreeTalking-Opinion-LG/FreeTalking-Opinion-LG1/unit1">0810-0904</a><br />
                <a href ="/book#/FreeTalking-Opinion-LG/FreeTalking-Opinion-LG2/unit1">0907-0929</a><br>
    ...
    <div class="container mt-2 pt-2">
        <div class="card" style="width: 18rem;">
            <div class="card-body">
              <h2>Grammar in Pattern Course</h2>
              <br />
                <a href ="/book#/pattern-course/grammar-in-pattern-basic/chapter1">Grammar in Pattern Basic</a><br />
                <a href ="/book#/pattern-course/grammar-in-pattern-intermediate/chapter1">Grammar in Pattern Intermediate</a>
            </div>
        </div>
    </div>
    ...
    <div class="container mt-2 pt-2">
        <div class="card" style="width: 18rem;">
            <div class="card-body">
              ...
              <br />
                ...
                <a href ="/book#/DialogueBooks/DialogueLevelRed4/unit1">Daily Dialogue - Red 4</a><br />
                <a href ="/book#/DialogueBooks/DialogueLevelBlack5/unit1">Daily Dialogue - Black 5</a><br />
            </div>
        </div>
    </div>
      ...
      <div class="container mt-2 pt-2">
          <div class="card" style="width: 18rem;">
              <div class="card-body">
                ...
                <br />
                  <a href ="/book#/PrototypeBusiness/BusinessStep1/chapter1">Business Step 1</a><br />
                  <a href ="/book#/PrototypeBusiness/BusinessStep2/chapter1">Business Step 2</a><br />
                  <a href ="/book#/PrototypeBusiness/BusinessStep3/chapter1">Business Step 3</a><br />
                  <a href ="/book#/PrototypeBusiness/BusinessStep4/chapter1">Business Step 4</a>
              </div>
          </div>
      </div>
      ...
      <div class="container mt-2 pt-2">
          <div class="card" style="width: 18rem;">
              <div class="card-body">
                  <a href ="/book#/TravelEnglish/TravelEnglish1/chapter1">Travel English</a>
              </div>
          </div>
      </div>
      ...
      <!-- <div class="container mt-2 pt-2">
          <div class="card" style="width: 18rem;">
              <div class="card-body">
                  <a href ="/book#/pattern-course/adultadvance/chapter1">Pattern Adult Advance</a><br />
              </div>
          </div>
      </div> -->
      ...
      <div class="container mt-2 pt-2">
          <div class="card" style="width: 18rem;">
              <div class="card-body">
                  <a href ="/book#/freetalking/intermediate/chapter1">Freetalking Adult Intermediate</a>
              </div>
          </div>
      </div>
      ...
      <!-- <div class="container mt-2 pt-2">
          <div class="card" style="width: 18rem;">
              <div class="card-body">
                ...
                <br />
                  <a href ="/book#/pattern-course/adultbasic/chapter1">Pattern Junior Basic</a><br />
                  <a href ="/book#/pattern-course/adultadvance/chapter1">Pattern Junior Advance</a><br />
      ...
      <div class="container mt-2 pt-2">
          <div class="card" style="width: 18rem;">
              <div class="card-body">
                <h2>Debatable Topics</h2>
                <br>
                  <a href ="/book#/Debatable-Topics/Debatable-Topics1/unit1">Debatable Topics Step 1</a><br>
                  <a href ="/book#/Debatable-Topics/Debatable-Topics2/unit1">Debatable Topics Step 2</a>
              </div>
          </div>
      </div>
      ...
      <div class="container mt-2 pt-2">
          <div class="card" style="width: 18rem;">
              <div class="card-body">
                ...
                <br>
                  <a href ="/book#/Situational-Dialogues/Situational-Dialogues1/unit1">Situational Dialogues 1</a>
              </div>
          </div>
      </div>
      ...
      <div class="container mt-2 pt-2">
          <div class="card" style="width: 18rem;">
              <div class="card-body">
                ...
                <br>
                  <a href ="/book#/Discussion-Analysis/Discussion-Analysis1/unit1">Discussion and Analysis 1</a>
              </div>
          </div>
      </div>
      ...
      <div class="container mt-2 pt-2">
          <div class="card" style="width: 18rem;">
              <div class="card-body">
                <h2>First Step in Conversation</h2>
                <br>
                  <a href ="/book#/First-Step-in-Conversation/First-Step-in-Conversation1/unit1">First Step in Conversation 1</a>
              </div>
          </div>
      </div>
      ...
      <div class="container mt-2 pt-2">
          <div class="card" style="width: 18rem;">
              <div class="card-body">
                <h2>Milestone</h2>
                <br>
                  <a href ="/book#/Milestones/Milestone1/unit1">Milestone 1</a>
              </div>
          </div>
      </div>
