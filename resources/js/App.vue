...
<div v-if="$route.name === 'FreeTalking_Opinion_LG7'">
  <v-layout>
    <v-navigation-drawer v-model="drawer" :mini-variant="mini" absolute style="background-color:#E5E5E5; position:fixed; top:0; left:0; overflow-y:hidden;" temporary>
      <v-list class="pa-1">
        <v-list-tile avatar>
      ...
      <v-list>
        ...
        <v-list class="custom-list">
          ...
          <v-list-tile class = "lg" :class="{'lastUrl': onHighlight == 'unit1'}" @click="$router.push('/FreeTalking-Opinion-LG/FreeTalking-Opinion-LG7/unit' + 1) ">[02/22] Is Cancel Culture Good for Society?<br>캔슬 컬처는 사회에 좋은 영향을 주는가?</v-list-tile>       
          <v-list-tile class = "lg" :class="{'lastUrl': onHighlight == 'unit2'}" @click="$router.push('/FreeTalking-Opinion-LG/FreeTalking-Opinion-LG7/unit' + 2) ">[02/23] Vocal Tone Versus Vocal Range<br>음색 대 음역대</v-list-tile>
          <v-list-tile class = "lg" :class="{'lastUrl': onHighlight == 'unit3'}" @click="$router.push('/FreeTalking-Opinion-LG/FreeTalking-Opinion-LG7/unit' + 3) ">[02/24] Alternative Energy Versus Fossil Fuels<br>대체 에너지 대 화석 연료</v-list-tile>
          <v-list-tile class = "lg" :class="{'lastUrl': onHighlight == 'unit4'}" @click="$router.push('/FreeTalking-Opinion-LG/FreeTalking-Opinion-LG7/unit' + 4) ">[02/25] Should we just ban soft drinks altogether?<br>탄산음료를 금지해야 할까요?</v-list-tile>
          <v-list-tile class = "lg" :class="{'lastUrl': onHighlight == 'unit5'}" @click="$router.push('/FreeTalking-Opinion-LG/FreeTalking-Opinion-LG7/unit' + 5) ">[02/26] Dishwashers Versus Dishwashing<br>식기 세척기 대 손 설거지</v-list-tile>
          <v-list-tile class = "lg" :class="{'lastUrl': onHighlight == 'unit6'}" @click="$router.push('/FreeTalking-Opinion-LG/FreeTalking-Opinion-LG7/unit' + 6) ">[03/02] Bread Versus Rice Cakes<br>빵 대 떡</v-list-tile>
          <v-list-tile class = "lg" :class="{'lastUrl': onHighlight == 'unit7'}" @click="$router.push('/FreeTalking-Opinion-LG/FreeTalking-Opinion-LG7/unit' + 7) ">[03/03] Solo Singers Versus Groups<br>솔로 가수 대 그룹</v-list-tile>
          <v-list-tile class = "lg" :class="{'lastUrl': onHighlight == 'unit8'}" @click="$router.push('/FreeTalking-Opinion-LG/FreeTalking-Opinion-LG7/unit' + 8) ">[03/04] Soft Versus Firm Beds<br>푹신한 침대 대 단단한 침대</v-list-tile>
          <v-list-tile class = "lg" :class="{'lastUrl': onHighlight == 'unit9'}" @click="$router.push('/FreeTalking-Opinion-LG/FreeTalking-Opinion-LG7/unit' + 9) ">[03/05] Should skateboarding, biking, and skating be banned in public places?<br>스케이트 보드, 자전거, 스케이트를 공공 장소에서 금지해야 할까?</v-list-tile>
          <v-list-tile class = "lg" :class="{'lastUrl': onHighlight == 'unit10'}" @click="$router.push('/FreeTalking-Opinion-LG/FreeTalking-Opinion-LG7/unit' + 10) ">[03/08] Comedy Movies Versus Horror Movies<br>코미디 영화 대 공포 영화</v-list-tile>
          <v-list-tile class = "lg" :class="{'lastUrl': onHighlight == 'unit11'}" @click="$router.push('/FreeTalking-Opinion-LG/FreeTalking-Opinion-LG7/unit' + 11) ">[03/09] Should we go back to film photography?<br>우리는 다시 필름 사진을 찍어야 할까요?</v-list-tile>
          <v-list-tile class = "lg" :class="{'lastUrl': onHighlight == 'unit12'}" @click="$router.push('/FreeTalking-Opinion-LG/FreeTalking-Opinion-LG7/unit' + 12) ">[03/10] Are Carbs Bad for You?<br>탄수화물은 건강에 안 좋은가?</v-list-tile>
          <v-list-tile class = "lg" :class="{'lastUrl': onHighlight == 'unit13'}" @click="$router.push('/FreeTalking-Opinion-LG/FreeTalking-Opinion-LG7/unit' + 13) ">[03/11] Audiobooks Versus Paper Books<br>종이책 대 오디오북</v-list-tile>
          <v-list-tile class = "lg" :class="{'lastUrl': onHighlight == 'unit14'}" @click="$router.push('/FreeTalking-Opinion-LG/FreeTalking-Opinion-LG7/unit' + 14) ">[03/12] Should kids be allowed to do extreme sports?<br>아이들이 위험한 익스트림 스포츠를 해도 괜찮을까?</v-list-tile>
          <v-list-tile class = "lg" :class="{'lastUrl': onHighlight == 'unit15'}" @click="$router.push('/FreeTalking-Opinion-LG/FreeTalking-Opinion-LG7/unit' + 15) ">[03/15] Staying Warm in the Winter<br>겨울을 따뜻하게 보내는 방법</v-list-tile>
          <v-list-tile class = "lg" :class="{'lastUrl': onHighlight == 'unit16'}" @click="$router.push('/FreeTalking-Opinion-LG/FreeTalking-Opinion-LG7/unit' + 16) ">[03/16] Pianos Versus Guitars<br>피아노 대 기타</v-list-tile>
          <v-list-tile class = "lg" :class="{'lastUrl': onHighlight == 'unit17'}" @click="$router.push('/FreeTalking-Opinion-LG/FreeTalking-Opinion-LG7/unit' + 17) ">[03/17] Microwaves Versus Air Fryers<br>전자레인지 대 에어프라이어</v-list-tile>
          <v-list-tile class = "lg" :class="{'lastUrl': onHighlight == 'unit18'}" @click="$router.push('/FreeTalking-Opinion-LG/FreeTalking-Opinion-LG7/unit' + 18) ">[03/18] Fruits Versus Vegetables<br>과일 대 야채</v-list-tile>
          <v-list-tile class = "lg" :class="{'lastUrl': onHighlight == 'unit19'}" @click="$router.push('/FreeTalking-Opinion-LG/FreeTalking-Opinion-LG7/unit' + 19) ">[03/19] Robot Dogs Versus Real Dogs<br>로봇 강아지 대 진짜 강아지</v-list-tile>
        </v-list>
      </v-list>
